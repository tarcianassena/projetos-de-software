...
| US06 | Eu, como usuário/empregador, desejo trazer visibilidade para minhas publicações | O usuário/empregador deve poder impulsionar suas publicações por meio de plano premium | Could |
...
| ID | História de Usuário | Critérios de Aceitação | Prioridade |
| -- | ------------------- | ---------------------- | ---------- |
| US17 | Eu, como usuário regular, desejo que o sistema esteja disponível na maioria dos sistemas operacionais mobile disponíveis | A maioria dos usuários com diferentes versões e sistemas operacionais mobile devem conseguir utilizar a aplicação | Must | 
| US18 | Eu, como usuário regular, desejo que o sistema seja responsivo | O Sistema não deve apresentar travamentos nem lentidão | Must |
| US19 | Eu, como usuário regular, desejo que sistema garanta a privacidade e segurança dos meus dados | O usuário deve ter seus dados armazanados com segurança | Must |
